...
_Generated at 2026-08-06T04:32:49+00:00_
...
| `mean_token_f1` | 1.0000 | 0.5528 | 1.0000 | -0.4472 | 0.0000 |
| `judge_accuracy` | 1.0000 | 0.5417 | 1.0000 | -0.4583 | 0.0000 |
| `mean_judge_score` | 5 | 3.4167 | 5 | -1.5833 | 0 |

## 2. Reading the deltas

- `retrieval_hit_rate`: dropped by 0.3333 under corruption; repaired is back at or above baseline (1.0000).
- `mean_token_f1`: dropped by 0.4472 under corruption; repaired is back at or above baseline (1.0000).
- `judge_accuracy`: dropped by 0.4583 under corruption; repaired is back at or above baseline (1.0000).
- `mean_judge_score`: dropped by 1.5833 under corruption; repaired is back at or above baseline (5.0000).
